...
show_interactive_menu() {
    ...
    echo "   - ⚠️  WARNING: This may take ~30-35 minutes on a 2024 MacBook Pro M3"
...
reproduce_all_results() {
    ...
    log INFO "========================================"
    echo ""
    log WARNING "This process may take ~30-35 minutes on a 2024 MacBook Pro M3"
...
run_automatic_reproduction() {
    ...
    echo "========================================"
    echo "⚠️  WARNING: This final step may take ~30-35 minutes on a 2024 MacBook Pro M3!"
