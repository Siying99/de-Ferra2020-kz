...
\begin{footnotesize}
  ...
  \parbox{0.9\textwidth}{
    \begin{tabbing}
      ...
      \texttt{~~~~Python~Pipeline:~~} \> \> \texttt{\href{https://github.com/Siying99/de-Ferra2020-kz/blob/main/Code/Python/README.md}{Code/Python/README.md}} \textnormal{(14 notebooks, Figs 1--5)} \\
