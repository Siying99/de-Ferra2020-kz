...
\begin{footnotesize}
  ...
  \parbox{0.9\textwidth}{
    \begin{tabbing}
      ...
      \texttt{~~~~~~~~Notebook:~~~~~~} \> \> \texttt{\href{https://github.com/Siying99/de-Ferra2020-kz/blob/main/deFerra2020\_bellman-stages.ipynb}{deFerra2020\_bellman-stages.ipynb}} \\
...
\begin{authorsinfo}
  \noindent \name{de~Ferra: Department of Economics, Stockholm University, \href{mailto:sergio.deferra@ne.su.se}{\texttt{sergio.deferra@ne.su.se}}} \newline
  \name{Mitman: Institute for International Economic Studies, Stockholm University, \href{mailto:kurt.mitman@iies.su.se}{\texttt{kurt.mitman@iies.su.se}}} \newline
  \name{Romei: Department of Economics, Stockholm School of Economics, \href{mailto:Federica.Romei@hhs.se}{\texttt{Federica.Romei@hhs.se}}}
\end{authorsinfo}
