...
- **`θ*` (foreign demand elasticity)**: paper text quotes 3.0; the MATLAB *computes* `theta_star` endogenously in `Main.m` line 254 to clear an asset-market identity. This row will be filled in by Phase C when we port the transition system.
